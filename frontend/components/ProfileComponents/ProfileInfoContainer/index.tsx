        ...
        () =>
            Object.entries(user)?.map(([key, value]) => {
                if (USER_INFO_FIELDS?.[key]) {
                    return (
                        <span className='w-full text-left text-sm font-regular text-[#7D8395]'>
    ...
    return (
        <div className='min-w-[280px] w-[280px] items-stretch px-4 py-8 shadow-sm border border-[#dcdcdc] bg-white rounded flex flex-col flex-grow gap-64 justify-between'>
            <div className='flex flex-col items-center w-full gap-16'>
                <div className='flex w-full items-center flex-col gap-4'>
                    <div className='rounded-full flex-shrink-0 w-[116px] h-[116px] overflow-clip'>
                        <Image
                            className='rounded-full w-[116px] h-[116px] overflow-clip'
            ...
            <div className='w-full'>
                <button className='w-full py-3 flex items-center justify-center text-[#2D76E9] bg-white hover:bg-[#bbd3fb] border border-[#2D76E9] rounded hover:shadow-sm'>
                    Edit Personal Info
                </button>
            </div>
        </div>
